...
def initialize_graphics():
    ...
    tileset_file = 'assets/spritesheet.png'
    ...
    floor_tile = [2, 13]  # Liste des tiles pour le sol
    tree_tile = [0, 1, 3, 4] # Liste des tiles pour les arbres
    rock_tile = [104] # Liste des tiles pour les pierres
    farm_tile = [36]
...
def render_map(screen, game_map, units, buildings, ais, view_x, view_y, max_width, max_height):
    ...
    for building in buildings:
        ...
        if building.building_type == 'Town Center':
            ...
            screen.blit(images['farm'], (screen_x, screen_y - TILE_HEIGHT // 4))  # Décalage pour la ferme
