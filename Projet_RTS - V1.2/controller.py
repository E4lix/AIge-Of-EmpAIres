...
from view_graphics import handle_input_pygame, render_map, screen_width, screen_height, tile_size, initialize_graphics
    ...
    while True:
        ...
        if key == curses.KEY_DOWN:
            ...
            if selected_option == 0:  # Sauvegarder
                ...
                curses.wrapper(main_menu_curses)
                return
...
def game_loop_curses(stdscr):
    ...
    while True:
        ...
        last_update_time = update_game(units, buildings, game_map, ai, delay=0.01, last_update_time=last_update_time)
...
def game_loop_graphics():
    ...
    # Initialiser pygame pour le mode graphique quand on en a besoin
